  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="mt-8 bg-[#1a1a1a] p-8 lg:p-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 border border-white/5"
      >
        ...
        <Link
          href="#contact"
          className="shrink-0 inline-flex items-center gap-3 font-['DM_Sans'] text-[11px] tracking-[0.3em] uppercase font-bold text-[#1c1c1c] bg-[#f5f5f5] px-8 py-4 hover:bg-white transition-colors duration-300"
        >
