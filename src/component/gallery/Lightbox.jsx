    ...
    >
      ...
      >
        ...
        <div className="w-full flex items-center justify-between mb-4 px-1">
          <div>
            <p className="font-['Bebas_Neue'] text-[#f5f5f5] text-2xl tracking-widest leading-none">
              {item.caption}
            </p>
            <p className="font-['DM_Sans'] text-[#f5f5f5]/40 text-[10px] tracking-[0.35em] uppercase mt-0.5 font-medium">
              {item.artist} · {item.category}
            </p>
          </div>
          <div className="flex items-center gap-4">
            <span className="font-['DM_Sans'] text-[#f5f5f5]/30 text-xs tracking-[0.3em]">
        ...
        {/* Image */}
        <div className="relative w-full max-h-[75vh] overflow-hidden bg-[#1a1a1a]">
          <img
            src={item.src}
            alt={item.alt}
        ...
        <div className="flex items-center justify-between w-full mt-4 px-1">
          <button
            onClick={onPrev}
            className="flex items-center gap-2 font-['DM_Sans'] text-[10px] tracking-[0.3em] uppercase text-[#f5f5f5]/40 hover:text-[#f5f5f5] transition-colors duration-200 font-semibold group"
