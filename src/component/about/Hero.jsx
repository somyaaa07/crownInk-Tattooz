  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-end overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-12 w-full ">
        ...
        >
          <div className="h-px w-8 bg-white/30 mt-24" />
          <span className="font-['DM_Sans'] mt-24 text-white/40 text-[9px] sm:text-[11px] tracking-[0.2em] md:tracking-[0.5em] uppercase font-semibold">
        ...
        <div className="overflow-hidden mb-2">
          <motion.h1
            ...
            className="font-['Bebas_Neue'] text-white text-[16vw] lg:text-[11vw] leading-[0.9] tracking-wide"
          >
            About
          </motion.h1>
        </div>
